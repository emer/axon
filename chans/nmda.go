...
type NMDAParams struct {
	...
	Tau float32 `viewif:"Gbar>0" default:"30,50,100,200,300"`
	...
	ITau float32 `viewif:"Gbar>0" default:"1,100"`
	...
	MgC float32 `viewif:"Gbar>0" default:"1:1.5"`
	...
	Voff float32 `viewif:"Gbar>0" default:"0"`
