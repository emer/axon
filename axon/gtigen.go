...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"HasMod", &gti.Field{Name: "HasMod", Type: "github.com/emer/gosl/v2/slbool.Bool", LocalType: "slbool.Bool", Doc: "set automatically based on whether this layer has any recv projections that have a GType conductance type of Modulatory -- if so, then multiply GeSyn etc by GModSyn", Directives: gti.Directives{}, Tag: "inactive:\"+\""}},
...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"OnRew", &gti.Field{Name: "OnRew", Type: "github.com/emer/gosl/v2/slbool.Bool", LocalType: "slbool.Bool", Doc: "decay layer at end of ThetaCycle when there is a global reward -- true by default for PTPred, PTMaint and PFC Super layers", Directives: gti.Directives{}, Tag: ""}},
...
var _ = gti.AddType(&gti.Type{
	...
	Directives: gti.Directives{},
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		{"On", &gti.Field{Name: "On", Type: "github.com/emer/gosl/v2/slbool.Bool", LocalType: "slbool.Bool", Doc: "add noise simulating background spiking levels", Directives: gti.Directives{}, Tag: ""}},
...
var _ = gti.AddType(&gti.Type{
	...
	Directives: gti.Directives{},
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		{"IsInput", &gti.Field{Name: "IsInput", Type: "github.com/emer/gosl/v2/slbool.Bool", LocalType: "slbool.Bool", Doc: "is this a clamped input layer?  set automatically based on layer type at initialization", Directives: gti.Directives{}, Tag: "inactive:\"+\""}},
		{"IsTarget", &gti.Field{Name: "IsTarget", Type: "github.com/emer/gosl/v2/slbool.Bool", LocalType: "slbool.Bool", Doc: "is this a target layer?  set automatically based on layer type at initialization", Directives: gti.Directives{}, Tag: "inactive:\"+\""}},
...
var _ = gti.AddType(&gti.Type{
	...
	Directives: gti.Directives{},
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		{"On", &gti.Field{Name: "On", Type: "github.com/emer/gosl/v2/slbool.Bool", LocalType: "slbool.Bool", Doc: "is attentional modulation active?", Directives: gti.Directives{}, Tag: ""}},
...
var _ = gti.AddType(&gti.Type{
	...
	Directives: gti.Directives{},
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		{"On", &gti.Field{Name: "On", Type: "github.com/emer/gosl/v2/slbool.Bool", LocalType: "slbool.Bool", Doc: "use popcode encoding of variable(s) that this layer represents", Directives: gti.Directives{}, Tag: ""}},
		...
		{"Clip", &gti.Field{Name: "Clip", Type: "github.com/emer/gosl/v2/slbool.Bool", LocalType: "slbool.Bool", Doc: "ensure that encoded and decoded value remains within specified range", Directives: gti.Directives{}, Tag: "viewif:\"On\""}},
	}),
	Embeds:  ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{}),
	Methods: ordmap.Make([]ordmap.KeyVal[string, *gti.Method]{}),
})
...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"Gbar", &gti.Field{Name: "Gbar", Type: "invalid type", LocalType: "chans.Chans", Doc: "maximal conductances levels for channels", Directives: gti.Directives{}, Tag: "view:\"inline\""}},
		{"Erev", &gti.Field{Name: "Erev", Type: "invalid type", LocalType: "chans.Chans", Doc: "reversal potentials for each channel", Directives: gti.Directives{}, Tag: "view:\"inline\""}},
		...
		{"VmRange", &gti.Field{Name: "VmRange", Type: "github.com/emer/etable/v2/minmax.F32", LocalType: "minmax.F32", Doc: "range for Vm membrane potential -- -- important to keep just at extreme range of reversal potentials to prevent numerical instability", Directives: gti.Directives{}, Tag: "view:\"inline\""}},
		{"Mahp", &gti.Field{Name: "Mahp", Type: "invalid type", LocalType: "chans.MahpParams", Doc: "M-type medium time-scale afterhyperpolarization mAHP current -- this is the primary form of adaptation on the time scale of multiple sequences of spikes", Directives: gti.Directives{}, Tag: "view:\"inline\""}},
		{"Sahp", &gti.Field{Name: "Sahp", Type: "invalid type", LocalType: "chans.SahpParams", Doc: "slow time-scale afterhyperpolarization sAHP current -- integrates CaSpkD at theta cycle intervals and produces a hard cutoff on sustained activity for any neuron", Directives: gti.Directives{}, Tag: "view:\"inline\""}},
		{"KNa", &gti.Field{Name: "KNa", Type: "invalid type", LocalType: "chans.KNaMedSlow", Doc: "sodium-gated potassium channel adaptation parameters -- activates a leak-like current as a function of neural activity (firing = Na influx) at two different time-scales (Slick = medium, Slack = slow)", Directives: gti.Directives{}, Tag: "view:\"inline\""}},
		{"NMDA", &gti.Field{Name: "NMDA", Type: "invalid type", LocalType: "chans.NMDAParams", Doc: "NMDA channel parameters used in computing Gnmda conductance for bistability, and postsynaptic calcium flux used in learning.  Note that Learn.Snmda has distinct parameters used in computing sending NMDA parameters used in learning.", Directives: gti.Directives{}, Tag: "view:\"inline\""}},
		{"MaintNMDA", &gti.Field{Name: "MaintNMDA", Type: "invalid type", LocalType: "chans.NMDAParams", Doc: "NMDA channel parameters used in computing Gnmda conductance for bistability, and postsynaptic calcium flux used in learning.  Note that Learn.Snmda has distinct parameters used in computing sending NMDA parameters used in learning.", Directives: gti.Directives{}, Tag: "view:\"inline\""}},
		{"GabaB", &gti.Field{Name: "GabaB", Type: "invalid type", LocalType: "chans.GABABParams", Doc: "GABA-B / GIRK channel parameters", Directives: gti.Directives{}, Tag: "view:\"inline\""}},
		{"VGCC", &gti.Field{Name: "VGCC", Type: "invalid type", LocalType: "chans.VGCCParams", Doc: "voltage gated calcium channels -- provide a key additional source of Ca for learning and positive-feedback loop upstate for active neurons", Directives: gti.Directives{}, Tag: "view:\"inline\""}},
		{"AK", &gti.Field{Name: "AK", Type: "invalid type", LocalType: "chans.AKsParams", Doc: "A-type potassium (K) channel that is particularly important for limiting the runaway excitation from VGCC channels", Directives: gti.Directives{}, Tag: "view:\"inline\""}},
		{"SKCa", &gti.Field{Name: "SKCa", Type: "invalid type", LocalType: "chans.SKCaParams", Doc: "small-conductance calcium-activated potassium channel produces the pausing function as a consequence of rapid bursting.", Directives: gti.Directives{}, Tag: "view:\"inline\""}},
...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"PFailSWt", &gti.Field{Name: "PFailSWt", Type: "github.com/emer/gosl/v2/slbool.Bool", LocalType: "slbool.Bool", Doc: "if true, then probability of failure is inversely proportional to SWt structural / slow weight value (i.e., multiply PFail * (1-SWt)))", Directives: gti.Directives{}, Tag: ""}},
...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"PlusPhase", &gti.Field{Name: "PlusPhase", Type: "github.com/emer/gosl/v2/slbool.Bool", LocalType: "slbool.Bool", Doc: "true if this is the plus phase, when the outcome / bursting is occurring, driving positive learning -- else minus phase", Directives: gti.Directives{}, Tag: ""}},
		...
		{"RandCtr", &gti.Field{Name: "RandCtr", Type: "github.com/emer/gosl/v2/slrand.Counter", LocalType: "slrand.Counter", Doc: "random counter -- incremented by maximum number of possible random numbers generated per cycle, regardless of how many are actually used -- this is shared across all layers so must encompass all possible param settings.", Directives: gti.Directives{}, Tag: ""}},
	}),
	Embeds:  ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{}),
	Methods: ordmap.Make([]ordmap.KeyVal[string, *gti.Method]{}),
})
...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"pad", &gti.Field{Name: "pad", Type: "uint32", LocalType: "uint32", Doc: "", Directives: gti.Directives{}, Tag: ""}},
		{"pad1", &gti.Field{Name: "pad1", Type: "uint32", LocalType: "uint32", Doc: "", Directives: gti.Directives{}, Tag: ""}},
		{"pad2", &gti.Field{Name: "pad2", Type: "uint32", LocalType: "uint32", Doc: "", Directives: gti.Directives{}, Tag: ""}},
	}),
	Embeds:  ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{}),
	Methods: ordmap.Make([]ordmap.KeyVal[string, *gti.Method]{}),
})
...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"Sys", &gti.Field{Name: "Sys", Type: "*goki.dev/vgpu.System", LocalType: "*vgpu.System", Doc: "the vgpu compute system", Directives: gti.Directives{}, Tag: "view:\"-\""}},
		{"Params", &gti.Field{Name: "Params", Type: "*goki.dev/vgpu.VarSet", LocalType: "*vgpu.VarSet", Doc: "VarSet = 0: the uniform LayerParams", Directives: gti.Directives{}, Tag: "view:\"-\""}},
		{"Idxs", &gti.Field{Name: "Idxs", Type: "*goki.dev/vgpu.VarSet", LocalType: "*vgpu.VarSet", Doc: "VarSet = 1: the storage indexes and PrjnParams", Directives: gti.Directives{}, Tag: "view:\"-\""}},
		{"Structs", &gti.Field{Name: "Structs", Type: "*goki.dev/vgpu.VarSet", LocalType: "*vgpu.VarSet", Doc: "VarSet = 2: the Storage buffer for RW state structs and neuron floats", Directives: gti.Directives{}, Tag: "view:\"-\""}},
		{"Syns", &gti.Field{Name: "Syns", Type: "*goki.dev/vgpu.VarSet", LocalType: "*vgpu.VarSet", Doc: "Varset = 3: the Storage buffer for synapses", Directives: gti.Directives{}, Tag: "view:\"-\""}},
		{"SynCas", &gti.Field{Name: "SynCas", Type: "*goki.dev/vgpu.VarSet", LocalType: "*vgpu.VarSet", Doc: "Varset = 4: the Storage buffer for SynCa banks", Directives: gti.Directives{}, Tag: "view:\"-\""}},
...
var _ = gti.AddType(&gti.Type{
	...
	Directives: gti.Directives{},
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		{"On", &gti.Field{Name: "On", Type: "github.com/emer/gosl/v2/slbool.Bool", LocalType: "slbool.Bool", Doc: "use topographic inhibition", Directives: gti.Directives{}, Tag: ""}},
		...
		{"Wrap", &gti.Field{Name: "Wrap", Type: "github.com/emer/gosl/v2/slbool.Bool", LocalType: "slbool.Bool", Doc: "half-width of topographic inhibition within layer", Directives: gti.Directives{}, Tag: "viewif:\"On\""}},
...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"Layer", &gti.Field{Name: "Layer", Type: "invalid type", LocalType: "fsfffb.GiParams", Doc: "inhibition across the entire layer -- inputs generally use Gi = 0.8 or 0.9, 1.3 or higher for sparse layers.  If the layer has sub-pools (4D shape) then this is effectively between-pool inhibition.", Directives: gti.Directives{}, Tag: "view:\"inline\""}},
		{"Pool", &gti.Field{Name: "Pool", Type: "invalid type", LocalType: "fsfffb.GiParams", Doc: "inhibition within sub-pools of units, for layers with 4D shape -- almost always need this if the layer has pools.", Directives: gti.Directives{}, Tag: "view:\"inline\""}},
	}),
	Embeds:  ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{}),
	Methods: ordmap.Make([]ordmap.KeyVal[string, *gti.Method]{}),
})
...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"Ps", &gti.Field{Name: "Ps", Type: "goki.dev/mat32.Vec3", LocalType: "mat32.Vec3", Doc: "position of lower-left-hand corner of layer in 3D space, computed from Rel.  Layers are in X-Y width - height planes, stacked vertically in Z axis.", Directives: gti.Directives{}, Tag: "tableview:\"-\""}},
		...
		{"RepShp", &gti.Field{Name: "RepShp", Type: "github.com/emer/etable/v2/etensor.Shape", LocalType: "etensor.Shape", Doc: "shape of representative units in the layer -- if RepIxs is empty or .Shp is nil, use overall layer shape", Directives: gti.Directives{}, Tag: "view:\"-\""}},
...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"SpkVGCC", &gti.Field{Name: "SpkVGCC", Type: "github.com/emer/gosl/v2/slbool.Bool", LocalType: "slbool.Bool", Doc: "use spikes to generate VGCC instead of actual VGCC current -- see SpkVGCCa for calcium contribution from each spike", Directives: gti.Directives{}, Tag: "def:\"true\""}},
		...
		{"Dt", &gti.Field{Name: "Dt", Type: "invalid type", LocalType: "kinase.CaDtParams", Doc: "time constants for integrating CaLrn across M, P and D cascading levels", Directives: gti.Directives{}, Tag: "view:\"inline\""}},
...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"pad", &gti.Field{Name: "pad", Type: "int32", LocalType: "int32", Doc: "", Directives: gti.Directives{}, Tag: ""}},
		{"Dt", &gti.Field{Name: "Dt", Type: "invalid type", LocalType: "kinase.CaDtParams", Doc: "time constants for integrating CaSpk across M, P and D cascading levels -- these are typically the same as in CaLrn and Prjn level for synaptic integration, except for the M factor.", Directives: gti.Directives{}, Tag: "view:\"inline\""}},
	}),
	Embeds:  ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{}),
	Methods: ordmap.Make([]ordmap.KeyVal[string, *gti.Method]{}),
})
...
var _ = gti.AddType(&gti.Type{
	...
	Directives: gti.Directives{},
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		{"On", &gti.Field{Name: "On", Type: "github.com/emer/gosl/v2/slbool.Bool", LocalType: "slbool.Bool", Doc: "whether to use target average activity mechanism to scale synaptic weights", Directives: gti.Directives{}, Tag: ""}},
...
var _ = gti.AddType(&gti.Type{
	...
	Directives: gti.Directives{},
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		{"On", &gti.Field{Name: "On", Type: "github.com/emer/gosl/v2/slbool.Bool", LocalType: "slbool.Bool", Doc: "use learning rate modulation", Directives: gti.Directives{}, Tag: "def:\"true\""}},
		...
		{"Diff", &gti.Field{Name: "Diff", Type: "github.com/emer/gosl/v2/slbool.Bool", LocalType: "slbool.Bool", Doc: "modulate learning rate as a function of plus - minus differences", Directives: gti.Directives{}, Tag: "viewif:\"On\""}},
...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"LrnNMDA", &gti.Field{Name: "LrnNMDA", Type: "invalid type", LocalType: "chans.NMDAParams", Doc: "NMDA channel parameters used for learning, vs. the ones driving activation -- allows exploration of learning parameters independent of their effects on active maintenance contributions of NMDA, and may be supported by different receptor subtypes", Directives: gti.Directives{}, Tag: "view:\"inline\""}},
...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"Sym", &gti.Field{Name: "Sym", Type: "github.com/emer/gosl/v2/slbool.Bool", LocalType: "slbool.Bool", Doc: "symmetrize the initial weight values with those in reciprocal projection -- typically true for bidirectional excitatory connections", Directives: gti.Directives{}, Tag: "def:\"true\""}},
	}),
	Embeds:  ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{}),
	Methods: ordmap.Make([]ordmap.KeyVal[string, *gti.Method]{}),
})
...
var _ = gti.AddType(&gti.Type{
	...
	Directives: gti.Directives{},
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		{"On", &gti.Field{Name: "On", Type: "github.com/emer/gosl/v2/slbool.Bool", LocalType: "slbool.Bool", Doc: "if true, adaptation is active -- if false, SWt values are not updated, in which case it is generally good to have Init.SPct=0 too.", Directives: gti.Directives{}, Tag: ""}},
...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"Limit", &gti.Field{Name: "Limit", Type: "github.com/emer/etable/v2/minmax.F32", LocalType: "minmax.F32", Doc: "range limits for SWt values", Directives: gti.Directives{}, Tag: "def:\"{'Min':0.2,'Max':0.8}\" view:\"inline\""}},
	}),
	Embeds:  ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{}),
	Methods: ordmap.Make([]ordmap.KeyVal[string, *gti.Method]{}),
})
...
var _ = gti.AddType(&gti.Type{
	...
	Directives: gti.Directives{},
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		{"On", &gti.Field{Name: "On", Type: "github.com/emer/gosl/v2/slbool.Bool", LocalType: "slbool.Bool", Doc: "toggle use of this modulation factor", Directives: gti.Directives{}, Tag: ""}},
...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		{"Learn", &gti.Field{Name: "Learn", Type: "github.com/emer/gosl/v2/slbool.Bool", LocalType: "slbool.Bool", Doc: "enable learning for this projection", Directives: gti.Directives{}, Tag: ""}},
		{"pad", &gti.Field{Name: "pad", Type: "int32", LocalType: "int32", Doc: "", Directives: gti.Directives{}, Tag: ""}},
		{"pad1", &gti.Field{Name: "pad1", Type: "int32", LocalType: "int32", Doc: "", Directives: gti.Directives{}, Tag: ""}},
		{"pad2", &gti.Field{Name: "pad2", Type: "int32", LocalType: "int32", Doc: "", Directives: gti.Directives{}, Tag: ""}},
		...
		{"KinaseCa", &gti.Field{Name: "KinaseCa", Type: "invalid type", LocalType: "kinase.CaParams", Doc: "kinase calcium Ca integration parameters", Directives: gti.Directives{}, Tag: "viewif:\"Learn\" view:\"inline\""}},
	}),
	Embeds:  ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{}),
	Methods: ordmap.Make([]ordmap.KeyVal[string, *gti.Method]{}),
})
...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"MinPos", &gti.Field{Name: "MinPos", Type: "goki.dev/mat32.Vec3", LocalType: "mat32.Vec3", Doc: "minimum display position in network", Directives: gti.Directives{}, Tag: "view:\"-\""}},
		{"MaxPos", &gti.Field{Name: "MaxPos", Type: "goki.dev/mat32.Vec3", LocalType: "mat32.Vec3", Doc: "maximum display position in network", Directives: gti.Directives{}, Tag: "view:\"-\""}},
...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"IsVS", &gti.Field{Name: "IsVS", Type: "github.com/emer/gosl/v2/slbool.Bool", LocalType: "slbool.Bool", Doc: "is this a ventral striatum (VS) matrix layer?  if true, the gating status of this layer is recorded in the Global state, and used for updating effort and other factors.", Directives: gti.Directives{}, Tag: ""}},
...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"EdIdx", &gti.Field{Name: "EdIdx", Type: "uint32", LocalType: "uint32", Doc: "starting and ending (exlusive) layer-wise indexes for the list of neurons in this pool", Directives: gti.Directives{}, Tag: "inactive:\"+\""}},
		...
		{"IsLayPool", &gti.Field{Name: "IsLayPool", Type: "github.com/emer/gosl/v2/slbool.Bool", LocalType: "slbool.Bool", Doc: "is this a layer-wide pool?  if not, it represents a sub-pool of units within a 4D layer", Directives: gti.Directives{}, Tag: "inactive:\"+\""}},
		{"Gated", &gti.Field{Name: "Gated", Type: "github.com/emer/gosl/v2/slbool.Bool", LocalType: "slbool.Bool", Doc: "for special types where relevant (e.g., MatrixLayer, BGThalLayer), indicates if the pool was gated", Directives: gti.Directives{}, Tag: "inactive:\"+\""}},
		{"pad", &gti.Field{Name: "pad", Type: "uint32", LocalType: "uint32", Doc: "", Directives: gti.Directives{}, Tag: ""}},
		{"Inhib", &gti.Field{Name: "Inhib", Type: "invalid type", LocalType: "fsfffb.Inhib", Doc: "fast-slow FFFB inhibition values", Directives: gti.Directives{}, Tag: "inactive:\"+\""}},
...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"ParamsHistory", &gti.Field{Name: "ParamsHistory", Type: "github.com/emer/emergent/v2/params.HistoryImpl", LocalType: "params.HistoryImpl", Doc: "provides a history of parameters applied to the layer", Directives: gti.Directives{}, Tag: "tableview:\"-\""}},
		{"RecvConNAvgMax", &gti.Field{Name: "RecvConNAvgMax", Type: "github.com/emer/etable/v2/minmax.AvgMax32", LocalType: "minmax.AvgMax32", Doc: "average and maximum number of recv connections in the receiving layer", Directives: gti.Directives{}, Tag: "tableview:\"-\" inactive:\"+\" view:\"inline\""}},
		{"SendConNAvgMax", &gti.Field{Name: "SendConNAvgMax", Type: "github.com/emer/etable/v2/minmax.AvgMax32", LocalType: "minmax.AvgMax32", Doc: "average and maximum number of sending connections in the sending layer", Directives: gti.Directives{}, Tag: "tableview:\"-\" inactive:\"+\" view:\"inline\""}},
...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"Rew", &gti.Field{Name: "Rew", Type: "github.com/emer/gosl/v2/slbool.Bool", LocalType: "slbool.Bool", Doc: "use the global Context.NeuroMod.HasRew flag -- if there is some kind of external reward being given, then ACh goes to 1, else 0 for this component", Directives: gti.Directives{}, Tag: "def:\"true\""}},
...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		{"PredRange", &gti.Field{Name: "PredRange", Type: "github.com/emer/etable/v2/minmax.F32", LocalType: "minmax.F32", Doc: "default 0.1..0.99 range of predictions that can be represented -- having a truncated range preserves some sensitivity in dopamine at the extremes of good or poor performance", Directives: gti.Directives{}, Tag: ""}},
	}),
	Embeds:  ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{}),
	Methods: ordmap.Make([]ordmap.KeyVal[string, *gti.Method]{}),
})
