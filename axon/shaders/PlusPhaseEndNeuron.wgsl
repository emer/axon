...
//////// import: "act-net.go"
fn PlusPhaseEndNeuron(i: u32) { //gosl:kernel
	let ctx = Ctx[0];
	...
	let layers=Layers[li]; LayerParams_PlusPhaseEndNeuron(layers, ctx, ni, di);
}
