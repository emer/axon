...
///////////// import: "act-layer.go"
fn LayerParams_LayerGi(ly: ptr<function,LayerParams>, ctx: ptr<function,Context>, li: u32,di: u32) {
	var lpi = LayerParams_PoolIndex(ly, u32(u32(0)));
	PoolAvgMaxCalc(lpi, di);
	PoolInhibIntToRaw(lpi, di);
	LayerParams_LayPoolGiFromSpikes(ly, ctx, lpi, di);
}
fn LayerParams_LayPoolGiFromSpikes(ly: ptr<function,LayerParams>, ctx: ptr<function,Context>, lpi: u32,di: u32) {
	...
	2], u32(LayerGiMult),u32((*ly).Index),u32(di))]);
}
