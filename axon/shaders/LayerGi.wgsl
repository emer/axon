...
//////// import: "act-layer.go"
fn LayerParams_LayerGi(ly: LayerParams, ctx: Context, li: u32,di: u32) {
...
fn LayerParams_LayPoolGiFromSpikes(ly: LayerParams, ctx: Context, lpi: u32,di: u32) {
...
fn LayerGi(i: u32) { //gosl:kernel
	...
	let layers=Layers[li]; LayerParams_LayerGi(layers, ctx, li, di);
}
