...
fn PoolCycleToPlus(pi: u32,di: u32) {
	for (var vr=0; vr<AMAvgDif; vr++) { // don't do AvgDif
		Pools[Index3D(TensorStrides[120], TensorStrides[121], TensorStrides[122], u32(pi), u32(di), u32(AvgMaxVarIndex(vr, AMPlus, Avg)))] = Pools[Index3D(TensorStrides[120], TensorStrides[121], TensorStrides[122], u32(pi), u32(di), u32(AvgMaxVarIndex(vr, AMCycle, Avg)))];
		Pools[Index3D(TensorStrides[120], TensorStrides[121], TensorStrides[122], u32(pi), u32(di), u32(AvgMaxVarIndex(vr, AMPlus, Max)))] = Pools[Index3D(TensorStrides[120], TensorStrides[121], TensorStrides[122], u32(pi), u32(di), u32(AvgMaxVarIndex(vr, AMCycle, Max)))];
	}
}
