...
fn PathParams_SynCa(pt: ptr<function,PathParams>, ctx: ptr<function,Context>, si: u32,ri: u32,di: u32, syCaP: ptr<function,f32>,syCaD: ptr<function,f32>) {
	var rb0 = Neurons[IndexF323D(Neurons[0], Neurons[1], Neurons[2], u32(ri),u32(di),u32(SpkBin0))];
	var sb0 = Neurons[IndexF323D(Neurons[0], Neurons[1], Neurons[2], u32(si),u32(di),u32(SpkBin0))];
	var rb1 = Neurons[IndexF323D(Neurons[0], Neurons[1], Neurons[2], u32(ri),u32(di),u32(SpkBin1))];
	var sb1 = Neurons[IndexF323D(Neurons[0], Neurons[1], Neurons[2], u32(si),u32(di),u32(SpkBin1))];
	var rb2 = Neurons[IndexF323D(Neurons[0], Neurons[1], Neurons[2], u32(ri),u32(di),u32(SpkBin2))];
	var sb2 = Neurons[IndexF323D(Neurons[0], Neurons[1], Neurons[2], u32(si),u32(di),u32(SpkBin2))];
	var rb3 = Neurons[IndexF323D(Neurons[0], Neurons[1], Neurons[2], u32(ri),u32(di),u32(SpkBin3))];
	var sb3 = Neurons[IndexF323D(Neurons[0], Neurons[1], Neurons[2], u32(si),u32(di),u32(SpkBin3))];
	var rb4 = Neurons[IndexF323D(Neurons[0], Neurons[1], Neurons[2], u32(ri),u32(di),u32(SpkBin4))];
	var sb4 = Neurons[IndexF323D(Neurons[0], Neurons[1], Neurons[2], u32(si),u32(di),u32(SpkBin4))];
	var rb5 = Neurons[IndexF323D(Neurons[0], Neurons[1], Neurons[2], u32(ri),u32(di),u32(SpkBin5))];
	var sb5 = Neurons[IndexF323D(Neurons[0], Neurons[1], Neurons[2], u32(si),u32(di),u32(SpkBin5))];
	var rb6 = Neurons[IndexF323D(Neurons[0], Neurons[1], Neurons[2], u32(ri),u32(di),u32(SpkBin6))];
	var sb6 = Neurons[IndexF323D(Neurons[0], Neurons[1], Neurons[2], u32(si),u32(di),u32(SpkBin6))];
	var rb7 = Neurons[IndexF323D(Neurons[0], Neurons[1], Neurons[2], u32(ri),u32(di),u32(SpkBin7))];
	var sb7 = Neurons[IndexF323D(Neurons[0], Neurons[1], Neurons[2], u32(si),u32(di),u32(SpkBin7))];
	var b0 = 0.1 * (rb0 * sb0);
	var b1 = 0.1 * (rb1 * sb1);
	var b2 = 0.1 * (rb2 * sb2);
	var b3 = 0.1 * (rb3 * sb3);
...
fn PathParams_DWtSynCortex(pt: ptr<function,PathParams>, ctx: ptr<function,Context>, syni: u32,si: u32,ri: u32,lpi: u32,pi: u32,di: u32, isTarget: bool) {
	...
	if (isTarget) {
		...
		err = tr * (Neurons[IndexF323D(Neurons[0], Neurons[1], Neurons[2], u32(ri),u32(di),u32(NrnCaP))] - Neurons[IndexF323D(Neurons[0], Neurons[1], Neurons[ // hiddens: recv NMDA Ca drives error signal w/ trace credit
		2], u32(ri),u32(di),u32(NrnCaD))]);
	}
...
fn PathParams_DWtSynVSMatrix(pt: ptr<function,PathParams>, ctx: ptr<function,Context>, syni: u32,si: u32,ri: u32,lpi: u32,pi: u32,di: u32) {
	...
	var rplus = Neurons[IndexF323D(Neurons[0], Neurons[1], Neurons[2], u32(ri),u32(di),u32(CaSpkP))];
	var rminus = Neurons[IndexF323D(Neurons[0], Neurons[1], Neurons[2], u32(ri),u32(di),u32(CaSpkD))];
	var sact = Neurons[IndexF323D(Neurons[0], Neurons[1], Neurons[2], u32(si),u32(di),u32(CaSpkD))];
