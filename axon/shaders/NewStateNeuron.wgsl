...
fn LayerParams_NewStateNeuron(ly: ptr<function,LayerParams>, ctx: ptr<function,Context>, ni: u32,di: u32) {
	...
	Neurons[IndexF323D(Neurons[0], Neurons[1], Neurons[2], u32(ni),u32(di),u32(CaDPrev))] = Neurons[IndexF323D(Neurons[0], Neurons[1], Neurons[2], u32(ni),u32(di),u32(CaD))];
	Neurons[IndexF323D(Neurons[0], Neurons[1], Neurons[2], u32(ni),u32(di),u32(CaPMax))] = 0.0;
	Neurons[IndexF323D(Neurons[0], Neurons[1], Neurons[2], u32(ni),u32(di),u32(CaPMaxCa))] = 0.0;
	...
	for (var i=0; i<8; i++) {
		Neurons[IndexF323D(Neurons[0], Neurons[1], Neurons[2], u32(ni),u32(di),u32(SpikeBin0 + NeuronVars(i)))] = 0.0;
	}
}
...
fn ActParams_KNaNewState(ac: ptr<function,ActParams>, ctx: ptr<function,Context>, ni: u32,di: u32) {
	if ((*ac).KNa.On == 1 && (*ac).KNa.TrialSlow == 1) {
		Neurons[IndexF323D(Neurons[0], Neurons[1], Neurons[2], u32(ni),u32(di),u32(GknaSlow))] += (*ac).KNa.Slow.Max * Neurons[IndexF323D(Neurons[0], Neurons[1], Neurons[2], u32(ni),u32(di),u32(CaDPrev))];
	}
}
