...
fn LayerParams_BetweenGi(ly: ptr<function,LayerParams>, ctx: ptr<function,Context>, di: u32) {
	...
	var maxGi = Pools[IndexF323D(Pools[0], Pools[1], Pools[2], u32(TotalGi),u32(lpi),u32(di))];
	...
	Pools[IndexF323D(Pools[0], Pools[1], Pools[2], u32(TotalGi),u32(lpi),u32(di))] = maxGi; // our inhib is max of us and everyone in the layer pool
}
fn LayerParams_BetweenLayerGiMax(ly: ptr<function,LayerParams>, di: u32, maxGi: f32, layIndex: i32) -> f32 {
	...
	var ogi = Pools[IndexF323D(Pools[0], Pools[1], Pools[2], u32(TotalGi),u32(opi),u32(di))];
	if (ogi > maxGi) {
		return ogi;
	}return maxGi;
}
