...
var _LayerTypes_descMap = map[LayerTypes]string{
	...
	24: `VTALayer represents the ventral tegmental area, which releases dopamine. It calls the Global VTA methods, and tracks resulting DA for visualization purposes.`,
