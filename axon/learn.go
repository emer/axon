...
type DWtParams struct {
	...
	// This is only applicable for pathways to [TargetLayer] layers
	...
	// in [LearnTimingParams]. This is rarely used and typically 10ms bins are best.
	SynCa20 slbool.Bool
	...
	// biased synaptic weight changes. The default of 1 works best in most cases.
