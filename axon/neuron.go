...
Neurons.Set(math.Float32frombits(math.Float32bits(Neurons[NrnFlags, ni, di]) | uint32(flag)), int(NrnFlags), int(ni), int(di))
}
...
goal.Run("Spike":, `cat:"Act"`,)
goal.Run("Spiked":, `cat:"Act"`,)
goal.Run("Act":, `cat:"Act"`,)
goal.Run("ActInt":, `cat:"Act"`,)
goal.Run("Ge":, `cat:"Act" range:"2"`,)
goal.Run("Gi":, `cat:"Act" auto-scale:"+"`,)
goal.Run("Gk":, `cat:"Act" auto-scale:"+"`,)
goal.Run("Inet":, `cat:"Act"`,)
goal.Run("Vm":, `cat:"Act" min:"0" max:"1"`,)
goal.Run("VmDend":, `cat:"Act" min:"0" max:"1"`,)
goal.Run("ISI":, `cat:"Act" auto-scale:"+"`,)
goal.Run("ISIAvg":, `cat:"Act" auto-scale:"+"`,)
goal.Run("Ext":, `cat:"Act"`,)
goal.Run("Target":, `cat:"Act"`,)

/////////////////////////////////////////
// Calcium for learning

goal.Run("CaSpkM":, `cat:"Learn"`,)
goal.Run("CaSpkP":, `cat:"Learn"`,)
goal.Run("CaSpkD":, `cat:"Learn"`,)
goal.Run("CaSpkPM":, `cat:"Learn"`,)
goal.Run("CaLrn":, `cat:"Learn"`,)
goal.Run("NrnCaM":, `cat:"Learn"`,)
goal.Run("NrnCaP":, `cat:"Learn"`,)
goal.Run("NrnCaD":, `cat:"Learn"`,)
goal.Run("CaDiff":, `cat:"Learn"`,)
goal.Run("RLRate":, `cat:"Learn" auto-scale:"+"`,)

/////////////////////////////////////////
// NMDA channels

goal.Run("GnmdaSyn":, `cat:"Excite" auto-scale:"+"`,)
goal.Run("Gnmda":, `cat:"Excite" auto-scale:"+"`,)
goal.Run("GnmdaLrn":, `cat:"Excite" auto-scale:"+"`,)
goal.Run("GnmdaMaint":, `cat:"Excite" auto-scale:"+"`,)
goal.Run("NmdaCa":, `cat:"Excite" auto-scale:"+"`,)

/////////////////////////////////////////
//  VGCC voltage gated calcium channels

goal.Run("Gvgcc":, `cat:"Excite" auto-scale:"+"`,)
goal.Run("VgccM":, `cat:"Excite"`,)
goal.Run("VgccH":, `cat:"Excite"`,)
goal.Run("VgccCa":, `cat:"Excite" auto-scale:"+"`,)
goal.Run("VgccCaInt":, `cat:"Excite" auto-scale:"+"`,)

/////////////////////////////////////////
//  Misc Excitatory Vars

goal.Run("Burst":, `cat:"Excite"`,)
goal.Run("BurstPrv":, `cat:"Excite"`,)
goal.Run("CtxtGe":, `cat:"Excite"`,)
goal.Run("CtxtGeRaw":, `cat:"Excite"`,)
goal.Run("CtxtGeOrig":, `cat:"Excite"`,)

/////////////////////////////////////////
// GABA channels

goal.Run("GgabaB":, `cat:"Inhib" auto-scale:"+"`,)
goal.Run("GABAB":, `cat:"Inhib" auto-scale:"+"`,)
goal.Run("GABABx":, `cat:"Inhib" auto-scale:"+"`,)

/////////////////////////////////////////
// SST somatostatin inhibition factors

goal.Run("Gak":, `cat:"Inhib" auto-scale:"+"`,)
goal.Run("SSGi":, `cat:"Inhib" auto-scale:"+"`,)
goal.Run("SSGiDend":, `cat:"Inhib" auto-scale:"+"`,)

goal.Run("GknaMed":, `cat:"Inhib" auto-scale:"+"`,)
goal.Run("GknaSlow":, `cat:"Inhib" auto-scale:"+"`,)
goal.Run("Gkir":, `cat:"Inhib"`,)
goal.Run("KirM":, `cat:"Inhib"`,)

/////////////////////////////////////////
//  SKCa small conductance calcium-gated potassium channels

goal.Run("Gsk":, `cat:"Inhib"`,)
goal.Run("SKCaIn":, `cat:"Inhib"`,)
goal.Run("SKCaR":, `cat:"Inhib"`,)
goal.Run("SKCaM":, `cat:"Inhib"`,)

/////////////////////////////////////////
// AHP channels: Mahp, Sahp

goal.Run("Gmahp":, `cat:"Inhib" auto-scale:"+"`,)
goal.Run("MahpN":, `cat:"Inhib" auto-scale:"+"`,)
goal.Run("Gsahp":, `cat:"Inhib" auto-scale:"+"`,)
goal.Run("SahpCa":, `cat:"Inhib"`,)
goal.Run("SahpN":, `cat:"Inhib"`,)

/////////////////////////////////////////
// Stats, aggregate values

goal.Run("ActM":, `cat:"Stats"`,)
goal.Run("ActP":, `cat:"Stats"`,)
goal.Run("SpkSt1":, `cat:"Stats"`,)
goal.Run("SpkSt2":, `cat:"Stats"`,)
goal.Run("SpkMax":, `cat:"Stats"`,)
goal.Run("SpkMaxCa":, `cat:"Stats"`,)

goal.Run("SpkBin0":, `cat:"Stats" min:"0" max:"10"`,)
goal.Run("SpkBin1":, `cat:"Stats" min:"0" max:"10"`,)
goal.Run("SpkBin2":, `cat:"Stats" min:"0" max:"10"`,)
goal.Run("SpkBin3":, `cat:"Stats" min:"0" max:"10"`,)
goal.Run("SpkBin4":, `cat:"Stats" min:"0" max:"10"`,)
goal.Run("SpkBin5":, `cat:"Stats" min:"0" max:"10"`,)
goal.Run("SpkBin6":, `cat:"Stats" min:"0" max:"10"`,)
goal.Run("SpkBin7":, `cat:"Stats" min:"0" max:"10"`,)

goal.Run("SpkPrv":, `cat:"Stats"`,)

/////////////////////////////////////////
// Noise

goal.Run("GeNoise":, `cat:"Gmisc"`,)
goal.Run("GeNoiseP":, `cat:"Gmisc"`,)
goal.Run("GiNoise":, `cat:"Gmisc"`,)
goal.Run("GiNoiseP":, `cat:"Gmisc"`,)

/////////////////////////////////////////
// Ge, Gi integration

goal.Run("GeExt":, `cat:"Gmisc"`,)
goal.Run("GeRaw":, `cat:"Gmisc"`,)
goal.Run("GeSyn":, `cat:"Gmisc" range:"2"`,)
goal.Run("GiRaw":, `cat:"Gmisc"`,)
goal.Run("GiSyn":, `cat:"Gmisc"`,)
goal.Run("GeInt":, `cat:"Gmisc" range:"2"`,)
goal.Run("GeIntNorm":, `cat:"Gmisc" range:"1"`,)
goal.Run("GiInt":, `cat:"Gmisc" range:"2"`,)
goal.Run("GModRaw":, `cat:"Gmisc"`,)
goal.Run("GModSyn":, `cat:"Gmisc"`,)
goal.Run("SMaintP":, `cat:"Gmisc"`,)
goal.Run("GMaintRaw":, `cat:"Gmisc"`,)
goal.Run("GMaintSyn":, `cat:"Gmisc"`,)

goal.Run("NrnFlags":, `display:"-"`,)

/////////////////////////////////////////
// Long-term average activation, set point for synaptic scaling

goal.Run("ActAvg":, `cat:"Avg"`,)
goal.Run("AvgPct":, `cat:"Avg" range:"2"`,)
goal.Run("TrgAvg":, `cat:"Avg" range:"2"`,)
goal.Run("DTrgAvg":, `cat:"Avg" auto-scale:"+"`,)
goal.Run("AvgDif":, `cat:"Avg"`,)
goal.Run("GeBase":, `cat:"Avg"`,)
goal.Run("GiBase":, `cat:"Avg"`,)

/////////////////////////////////////////
// Layer-level variables

goal.Run("DA":, `cat:"Learn" doc:"dopamine neuromodulation (layer-level variable)"`,)
goal.Run("ACh":, `cat:"Learn" doc:"cholinergic neuromodulation (layer-level variable)"`,)
goal.Run("NE":, `cat:"Learn" doc:"norepinepherine (noradrenaline) neuromodulation  (layer-level variable)"`,)
goal.Run("Ser":, `cat:"Learn" doc:"serotonin neuromodulation (layer-level variable)"`,)
goal.Run("Gated":, `cat:"Learn" doc:"signals whether the layer gated"`,)
}
