...
type DtParams struct {
	...
	MaxCycStart int32   `def:"25" min:"0" desc:"cycle to start updating the SpkMaxCa, SpkMax, GeIntMax values within a theta cycle -- early cycles often reflect prior state"`
