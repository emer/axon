...
type DecayParams struct {
	...
	// GBuffs resets the spike conductance buffers for receiving pathways into
	// this layer, creating a mild form of decay that cuts off prior inputs.
	GBuffs slbool.Bool
...
func (ac *ActParams) InitActs(ctx *Context, ni, di uint32) {
	...
	mx := NetworkIxs[0].NNeuronTraces
	for i := range mx {
		Neurons.Set(0.0, int(ni), int(di), int(NeuronTraces+NeuronVars(i)))
	}
