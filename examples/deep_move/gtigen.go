...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"World", &gti.Field{Name: "World", Type: "*github.com/emer/etable/v2/etensor.Int", LocalType: "*etensor.Int", Doc: "2D grid world, each cell is a material (mat)", Directives: gti.Directives{}, Tag: "view:\"no-inline\""}},
		...
		{"PosF", &gti.Field{Name: "PosF", Type: "goki.dev/mat32.Vec2", LocalType: "mat32.Vec2", Doc: "current location of agent, floating point", Directives: gti.Directives{}, Tag: "inactive:\"+\""}},
		...
		{"NextStates", &gti.Field{Name: "NextStates", Type: "map[string]*github.com/emer/etable/v2/etensor.Float32", LocalType: "map[string]*etensor.Float32", Doc: "next rendered state tensors -- updated from actions", Directives: gti.Directives{}, Tag: ""}},
