...
var ParamSetsDefs = params.Sets{
	...
	"NoTrainMtx": {Name: "NoTrainMtx", Desc: "turn off training in Mtx", Sheets: params.Sheets{
		"Network": &params.Sheet{
	...
	"LearnWts": {Name: "LearnWts", Desc: "learned weights", Sheets: params.Sheets{
		"Network": &params.Sheet{
	...
	"WtScales": {Name: "WtScales", Desc: "these should all be hard-coded", Sheets: params.Sheets{
		"Network": &params.Sheet{
