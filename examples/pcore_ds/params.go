...
var ParamSets = netparams.Sets{
	"Base": {
		...
		{Sel: ".DBG", Desc: "all bg",
			...
			Hypers: params.Hypers{
				"Layer.Acts.Mahp.Gbar": {"Tweak": "[0.01,0.015,0.02]"},
				"Layer.Acts.Sahp.Gbar": {"Tweak": "[0,0.03]"},
			}},
		{Sel: ".MatrixLayer", Desc: "all mtx",
			...
			Hypers: params.Hypers{
				...
				"Layer.Acts.Mahp.Gbar":           {"Tweak": "[0,0.01,0.02]"},
				"Layer.Acts.Sahp.Gbar":           {"Tweak": "[0,0.05]"},
			}},
		...
		{Sel: ".PFCLayer", Desc: "",
			...
			Hypers: params.Hypers{
				"Layer.Acts.Mahp.Gbar": {"Tweak": "[0,0.01,0.015]"},
				"Layer.Acts.Sahp.Gbar": {"Tweak": "[0,0.03]"},
			}},
