...
var _ = types.AddType(&types.Type{Name: "main.ParamConfig", IDName: "param-config", Doc: "ParamConfig has config parameters related to sim params.", Fields: []types.Field{{Name: "InputPct", Doc: "InputPct has the percent of active units in input layer\n(literally number of active units, because input has 100 units total)."}, {Name: "NLayers", Doc: "NLayers is the number of hidden layers to add."}, {Name: "HiddenSize", Doc: "HiddenSize is the size of hidden layers."}, {Name: "Sheet", Doc: "Sheet is the extra params sheet name(s) to use (space separated\nif multiple). Must be valid name as listed in compiled-in params\nor loaded params."}, {Name: "Tag", Doc: "Tag is an extra tag to add to file names and logs saved from this run."}, {Name: "Note", Doc: "Note is additional info to describe the run params etc,\nlike a git commit message for the run."}, {Name: "SaveAll", Doc: "SaveAll will save a snapshot of all current param and config settings\nin a directory named params_<datestamp> (or _good if Good is true),\nthen quit. Useful for comparing to later changes and seeing multiple\nviews of current params."}, {Name: "Good", Doc: "Good is for SaveAll, save to params_good for a known good params state.\nThis can be done prior to making a new release after all tests are passing.\nAdd results to git to provide a full diff record of all params over level."}}})

var _ = types.AddType(&types.Type{Name: "main.RunConfig", IDName: "run-config", Doc: "RunConfig has config parameters related to running the sim.", Fields: []types.Field{{Name: "GPU", Doc: "GPU uses the GPU for computation, largely for testing purposes here."}, {Name: "Trials", Doc: "Trials is the total number of trials of different random patterns to generate."}, {Name: "Cycles", Doc: "Cycles is the total number of cycles per trial: at least 200."}, {Name: "PlusCycles", Doc: "PlusCycles is the total number of plus-phase cycles per trial. For Cycles=300, use 100."}}})

var _ = types.AddType(&types.Type{Name: "main.LogConfig", IDName: "log-config", Doc: "LogConfig has config parameters related to logging data.", Fields: []types.Field{{Name: "Save", Doc: "Save has the list of levels to save log files for."}}})
...
var _ = types.AddFunc(&types.Func{Name: "main.LayNm", Args: []string{"n"}, Returns: []string{"string"}})

var _ = types.AddFunc(&types.Func{Name: "main.InhNm", Args: []string{"n"}, Returns: []string{"string"}})

var _ = types.AddFunc(&types.Func{Name: "main.LayByNm", Args: []string{"net", "n"}, Returns: []string{"Layer"}})

var _ = types.AddFunc(&types.Func{Name: "main.InhByNm", Args: []string{"net", "n"}, Returns: []string{"Layer"}})
