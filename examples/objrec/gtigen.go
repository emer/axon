...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"OrigImg", &gti.Field{Name: "OrigImg", Type: "github.com/emer/etable/v2/etensor.Float32", LocalType: "etensor.Float32", Doc: "original image prior to random transforms", Directives: gti.Directives{}, Tag: ""}},
		{"Output", &gti.Field{Name: "Output", Type: "github.com/emer/etable/v2/etensor.Float32", LocalType: "etensor.Float32", Doc: "CurLED one-hot output tensor", Directives: gti.Directives{}, Tag: ""}},
	}),
	Embeds:  ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{}),
	Methods: ordmap.Make([]ordmap.KeyVal[string, *gti.Method]{}),
})
