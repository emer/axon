...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"LineColor", &gti.Field{Name: "LineColor", Type: "invalid type", LocalType: "gi.ColorName", Doc: "color name for drawing lines", Directives: gti.Directives{}, Tag: ""}},
		{"BgColor", &gti.Field{Name: "BgColor", Type: "invalid type", LocalType: "gi.ColorName", Doc: "color name for background", Directives: gti.Directives{}, Tag: ""}},
		...
		{"Paint", &gti.Field{Name: "Paint", Type: "invalid type", LocalType: "girl.Paint", Doc: "painter object", Directives: gti.Directives{}, Tag: "view:\"+\""}},
		{"Render", &gti.Field{Name: "Render", Type: "goki.dev/girl/paint.State", LocalType: "paint.State", Doc: "rendering state", Directives: gti.Directives{}, Tag: "view:\"-\""}},
	}),
	Embeds:  ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{}),
	Methods: ordmap.Make([]ordmap.KeyVal[string, *gti.Method]{}),
})
