...
var _ = gti.AddType(&gti.Type{
	Name:       "github.com/emer/axon/v2/examples/dls/armaze.Arm",
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"Effort", &gti.Field{Name: "Effort", Type: "github.com/emer/etable/v2/minmax.F32", LocalType: "minmax.F32", Doc: "range of different effort levels per step (uniformly randomly sampled per step) for going down this arm", Directives: gti.Directives{}, Tag: ""}},
...
var _ = gti.AddType(&gti.Type{
	Name:       "github.com/emer/axon/v2/examples/dls/armaze.USParams",
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"Mag", &gti.Field{Name: "Mag", Type: "github.com/emer/etable/v2/minmax.F32", LocalType: "minmax.F32", Doc: "range of different magnitudes (uniformly sampled)", Directives: gti.Directives{}, Tag: ""}},
...
var _ = gti.AddType(&gti.Type{
	Name:       "github.com/emer/axon/v2/examples/dls/armaze.Params",
	ShortName:  "armaze.Params",
	IDName:     "params",
	Doc:        "Params are misc environment parameters",
	Directives: gti.Directives{},
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		{"TurnEffort", &gti.Field{Name: "TurnEffort", Type: "github.com/emer/etable/v2/minmax.F32", LocalType: "minmax.F32", Doc: "effort for turning", Directives: gti.Directives{}, Tag: "nest:\"+\" def:\"{'Min':0.5, 'Max':0.5}\""}},
		{"ConsumeEffort", &gti.Field{Name: "ConsumeEffort", Type: "github.com/emer/etable/v2/minmax.F32", LocalType: "minmax.F32", Doc: "effort for consuming US", Directives: gti.Directives{}, Tag: "nest:\"+\" def:\"{'Min':0.5, 'Max':0.5}\""}},
		...
		{"Inactive", &gti.Field{Name: "Inactive", Type: "github.com/emer/etable/v2/minmax.F32", LocalType: "minmax.F32", Doc: "strength of inactive inputs (e.g., Drives in Approach paradigm)", Directives: gti.Directives{}, Tag: "nest:\"+\" def:\"{'Min':0, 'Max':0}\" view:\"inline\""}},
...
var _ = gti.AddType(&gti.Type{
	Name:       "github.com/emer/axon/v2/examples/dls/armaze.Config",
	ShortName:  "armaze.Config",
	IDName:     "config",
	Doc:        "Config has environment configuration",
	Directives: gti.Directives{},
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		{"Paradigm", &gti.Field{Name: "Paradigm", Type: "github.com/emer/axon/v2/examples/dls/armaze.Paradigms", LocalType: "Paradigms", Doc: "experimental paradigm that governs the configuration and updating of environment state over time and the appropriate evaluation criteria.", Directives: gti.Directives{}, Tag: ""}},
		...
		{"USs", &gti.Field{Name: "USs", Type: "[]*github.com/emer/axon/v2/examples/dls/armaze.USParams", LocalType: "[]*USParams", Doc: "parameters associated with each US.  The first NDrives are positive USs, and beyond that are negative USs", Directives: gti.Directives{}, Tag: ""}},
		{"Arms", &gti.Field{Name: "Arms", Type: "[]*github.com/emer/axon/v2/examples/dls/armaze.Arm", LocalType: "[]*Arm", Doc: "state of each arm: dist, effort, US, CS", Directives: gti.Directives{}, Tag: ""}},
		{"Params", &gti.Field{Name: "Params", Type: "github.com/emer/axon/v2/examples/dls/armaze.Params", LocalType: "Params", Doc: "misc params", Directives: gti.Directives{}, Tag: "view:\"add-fields\""}},
	}),
	Embeds:  ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{}),
	Methods: ordmap.Make([]ordmap.KeyVal[string, *gti.Method]{}),
})
...
var _ = gti.AddType(&gti.Type{
	Name:       "github.com/emer/axon/v2/examples/dls/armaze.Geom",
...
var _ = gti.AddType(&gti.Type{
	Name:       "github.com/emer/axon/v2/examples/dls/armaze.GUI",
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"Env", &gti.Field{Name: "Env", Type: "*github.com/emer/axon/v2/examples/dls/armaze.Env", LocalType: "*Env", Doc: "the env being visualized", Directives: gti.Directives{}, Tag: ""}},
		...
		{"WallSize", &gti.Field{Name: "WallSize", Type: "goki.dev/mat32.Vec2", LocalType: "mat32.Vec2", Doc: "thickness (X) and height (Y) of walls", Directives: gti.Directives{}, Tag: ""}},
		{"State", &gti.Field{Name: "State", Type: "github.com/emer/axon/v2/examples/dls/armaze.TraceStates", LocalType: "TraceStates", Doc: "current internal / behavioral state", Directives: gti.Directives{}, Tag: ""}},
		{"Trace", &gti.Field{Name: "Trace", Type: "github.com/emer/axon/v2/examples/dls/armaze.StateTrace", LocalType: "StateTrace", Doc: "trace record of recent activity", Directives: gti.Directives{}, Tag: ""}},
		{"StructView", &gti.Field{Name: "StructView", Type: "*goki.dev/giv.StructView", LocalType: "*giv.StructView", Doc: "view of the gui obj", Directives: gti.Directives{}, Tag: "view:\"-\""}},
		{"WorldTabs", &gti.Field{Name: "WorldTabs", Type: "*goki.dev/gi.Tabs", LocalType: "*gi.Tabs", Doc: "ArmMaze TabView", Directives: gti.Directives{}, Tag: "view:\"-\""}},
		...
		{"DepthMap", &gti.Field{Name: "DepthMap", Type: "goki.dev/giv.ColorMapName", LocalType: "giv.ColorMapName", Doc: "color map to use for rendering depth map", Directives: gti.Directives{}, Tag: ""}},
		{"EyeRFullImg", &gti.Field{Name: "EyeRFullImg", Type: "*goki.dev/gi.Image", LocalType: "*gi.Image", Doc: "first-person right-eye full field view", Directives: gti.Directives{}, Tag: "view:\"-\""}},
		{"EyeRFovImg", &gti.Field{Name: "EyeRFovImg", Type: "*goki.dev/gi.Image", LocalType: "*gi.Image", Doc: "first-person right-eye fovea view", Directives: gti.Directives{}, Tag: "view:\"-\""}},
		{"DepthImg", &gti.Field{Name: "DepthImg", Type: "*goki.dev/gi.Image", LocalType: "*gi.Image", Doc: "depth map bitmap view", Directives: gti.Directives{}, Tag: "view:\"-\""}},
		{"USposPlot", &gti.Field{Name: "USposPlot", Type: "*github.com/emer/etable/v2/eplot.Plot2D", LocalType: "*eplot.Plot2D", Doc: "plot of positive valence drives, active OFC US state, and reward", Directives: gti.Directives{}, Tag: ""}},
		{"USposData", &gti.Field{Name: "USposData", Type: "*github.com/emer/etable/v2/etable.Table", LocalType: "*etable.Table", Doc: "data for USPlot", Directives: gti.Directives{}, Tag: ""}},
		{"USnegPlot", &gti.Field{Name: "USnegPlot", Type: "*github.com/emer/etable/v2/eplot.Plot2D", LocalType: "*eplot.Plot2D", Doc: "plot of negative valence active OFC US state, and outcomes", Directives: gti.Directives{}, Tag: ""}},
		{"USnegData", &gti.Field{Name: "USnegData", Type: "*github.com/emer/etable/v2/etable.Table", LocalType: "*etable.Table", Doc: "data for USPlot", Directives: gti.Directives{}, Tag: ""}},
		{"Geom", &gti.Field{Name: "Geom", Type: "github.com/emer/axon/v2/examples/dls/armaze.Geom", LocalType: "Geom", Doc: "geometry of world", Directives: gti.Directives{}, Tag: ""}},
...
var _ = gti.AddType(&gti.Type{
	Name:      "github.com/emer/axon/v2/examples/dls/armaze.Actions",
...
var _ = gti.AddType(&gti.Type{
	Name:       "github.com/emer/axon/v2/examples/dls/armaze.Env",
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"Config", &gti.Field{Name: "Config", Type: "github.com/emer/axon/v2/examples/dls/armaze.Config", LocalType: "Config", Doc: "configuration parameters", Directives: gti.Directives{}, Tag: ""}},
		...
		{"LastAct", &gti.Field{Name: "LastAct", Type: "github.com/emer/axon/v2/examples/dls/armaze.Actions", LocalType: "Actions", Doc: "last action taken", Directives: gti.Directives{}, Tag: "inactive:\"+\""}},
		...
		{"States", &gti.Field{Name: "States", Type: "map[string]*github.com/emer/etable/v2/etensor.Float32", LocalType: "map[string]*etensor.Float32", Doc: "named states -- e.g., USs, CSs, etc", Directives: gti.Directives{}, Tag: ""}},
...
var _ = gti.AddType(&gti.Type{
	Name:      "github.com/emer/axon/v2/examples/dls/armaze.Paradigms",
...
var _ = gti.AddType(&gti.Type{
	Name:      "github.com/emer/axon/v2/examples/dls/armaze.TraceStates",
...
var _ = gti.AddType(&gti.Type{
	Name:       "github.com/emer/axon/v2/examples/dls/armaze.TraceRec",
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"State", &gti.Field{Name: "State", Type: "github.com/emer/axon/v2/examples/dls/armaze.TraceStates", LocalType: "TraceStates", Doc: "behavioral / internal state summary", Directives: gti.Directives{}, Tag: ""}},
...
var _ = gti.AddType(&gti.Type{
	Name:       "github.com/emer/axon/v2/examples/dls/armaze.StateTrace",
