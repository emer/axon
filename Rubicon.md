...
The second factor regarding the nature of the longer-term "contextual" factors that influence immediate goal-selection dynamics is very relevant here.  If you somehow have a larger goal of getting a PhD because you think that will increase your social currency significantly, then that very long-term goal needs to be somehow translated into a large number of subtasks at finer temporal scales.  Somehow, it must boil down to "I will feel good if I write a paragraph of this paper", so that you can set that as an immediate goal.  It is unclear how all of that works, especially given that you (hopefully) only go through such a process once.  Clearly, a major advance in the human brain is the ability to organize our motivations around larger-scale abstractions, while not having that process completely undermine the efficacy of the underlying accounting process.  There are many unresolved questions here, but in any case, it is reasonable to at least start with the simple case of biologically-grounded immediate US outcomes for now.
