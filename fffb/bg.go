...
type Bg struct {
	...
	Tau float32 `def:"10" viewif:"On=true" desc:"time constant for integrating background inhibition (roughly, how long it takes for value to change significantly -- 1.4x the half-life)"`
