...
type Params struct {
	...
	FFEx     float32 `viewif:"On" def:"0,0.1" desc:"extra feedforward inhibition applied when average Ge exceeds a higher threshold -- produces a nonlinear inhibition effect that is consistent with a wide range of neuroscience data, including popout and the Reynolds & Heeger, 2009 attention model"`
	FFEx0    float32 `viewif:"On" def:"0.3" desc:"point of average Ge at which extra inhibition based on feedforward level starts"`
