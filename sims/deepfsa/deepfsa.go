...
func (ss *Sim) ConfigStats() {
	...
	ss.AddStatStd(axon.StatPrevCorSim(ss.Stats, ss.Current, net, Trial, Run, "InputP"))
	...
	ss.AddStatStd(axon.StatLayerState(ss.Stats, net, Test, Trial, true, "ActM", "Input", "InputP"))
}
