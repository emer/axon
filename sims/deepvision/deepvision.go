...
func (ss *Sim) ConfigStats() {
	...
	ss.AddStat(ss.StatCorSim())
	ss.AddStat(ss.StatPrevCorSim())
...
func (ss *Sim) StatCorSim() func(mode Modes, level Levels, start bool) {
	net := ss.Net
...
func (ss *Sim) StatPrevCorSim() func(mode Modes, level Levels, start bool) {
	net := ss.Net
