...
* PulvLayer: implement the Pulv (Pulvinar) neurons, upon which the prediction
  ...
  excitatory input in Pulv neurons.  The 5IB Burst-driven plus-phase "outcome"
...
continuously accessed by PulvLayer neurons to drive plus-phase outcome states.
