"""A function that instantiates go repositories.

Lives here so WORKSPACE.bazel does not get cluttered.
Should be called only in WORKSPACE.bazel.
Update it with the output of gazelle.
"""

load("@bazel_gazelle//:deps.bzl", "go_repository")

def go_repositories():
    """Instantiates gazelle's go repositories."""
    go_repository(
    ...
    go_repository(
        name = "com_github_akutz_sortfold",
        importpath = "github.com/akutz/sortfold",
        sum = "h1:u9x3FC6oM+6gZKEVNRnmVafJgappwrv9YqpELQCYViI=",
        version = "v0.2.1",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_anthonynsimon_bild",
        importpath = "github.com/anthonynsimon/bild",
        sum = "h1:mN3tMaNds1wBWi1BrJq0ipDBhpkooYfu7ZFSMhXt1C8=",
        version = "v0.13.0",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_burntsushi_freetype_go",
        importpath = "github.com/BurntSushi/freetype-go",
        sum = "h1:1qlsVAQJXZHsaM8b6OLVo6muQUQd4CwkH/D3fnnbHXA=",
        version = "v0.0.0-20160129220410-b763ddbfe298",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:7D+Bh06CRPCJO3gr2F7h1sriovOZ8BMhca2Rg85c2nk=",
        version = "v0.0.0-20210121224620-deaf085860bc",
    )
    go_repository(
        name = "com_github_burntsushi_xgbutil",
        importpath = "github.com/BurntSushi/xgbutil",
        sum = "h1:O/r2Sj+8QcMF7V5IcmiE2sMFV2q3J47BEirxbXJAdzA=",
        version = "v0.0.0-20190907113008-ad855c713046",
    )
    go_repository(
        name = "com_github_c2h5oh_datasize",
        importpath = "github.com/c2h5oh/datasize",
        sum = "h1:t8KYCwSKsOEZBFELI4Pn/phbp38iJ1RRAkDFNin1aak=",
        version = "v0.0.0-20200825124411-48ed595a09d2",
    )
    go_repository(
    ...
    go_repository(
        ...
        importpath = "github.com/emer/etable",
        sum = "h1:Cg0ih3sXKYBLiCwLYILE6yRNk3WdXwywMEVf9XY4Eto=",
        version = "v1.1.11",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:t9DznWJlXxxjeeKLIdovCOVJQk/GzDEL7h/h+Ro2B68=",
        version = "v1.0.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:JGCm/+tJ9gC6THUxooTldS+CUDsba0qvkvU3DHklqW8=",
        version = "v0.0.0-20220119013949-7a161fd3728c",
    )
    go_repository(
        name = "com_github_goki_gi",
        importpath = "github.com/goki/gi",
        sum = "h1:gS7HRKxponQSphCN+2657eeDynEs7iTHFmN+de52YwY=",
        version = "v1.3.7",
    )
    go_repository(
        name = "com_github_goki_go_difflib",
        importpath = "github.com/goki/go-difflib",
        sum = "h1:zqSi9rTf0vYFia92PaZeKrTfofGVqku2WYOtfsUYqxU=",
        version = "v1.2.1",
    )
    go_repository(
        name = "com_github_goki_ki",
        importpath = "github.com/goki/ki",
        sum = "h1:CAkUXKuPeyhEuoX7++Wi+S0FM8VwOPd5fxaT+Cbgm7E=",
        version = "v1.1.8",
    )
    go_repository(
        name = "com_github_goki_kigen",
        importpath = "github.com/goki/kigen",
        sum = "h1:txBgu8SXsPKDkHoSD8elob85bWjy6TEreVS3TYMz7pU=",
        version = "v1.0.1",
    )
    go_repository(
        name = "com_github_goki_mat32",
        importpath = "github.com/goki/mat32",
        sum = "h1:tuSKxqyZUkl1HbygYcDhGoysn3BGvCscXveTps6fdvs=",
        version = "v1.0.12",
    )
    go_repository(
        name = "com_github_goki_pi",
        importpath = "github.com/goki/pi",
        sum = "h1:0VkF9Dcj9R2DkQCA0q/OdcCxYa03WjYr+ehvKcFwxKU=",
        version = "v1.0.20",
    )
    go_repository(
        name = "com_github_goki_prof",
        importpath = "github.com/goki/prof",
        sum = "h1:kDkH1t4FpV7XYTEp2kJeQbI0l994bXg5dTzKw7hysKQ=",
        version = "v1.0.0",
    )
    go_repository(
        name = "com_github_goki_vci",
        importpath = "github.com/goki/vci",
        sum = "h1:tHtx4LzSNM1WeAYVf3e7hdinZmCizJMkE0NyYX/eXp0=",
        version = "v1.0.1",
    )
    go_repository(
        name = "com_github_goki_vgpu",
        importpath = "github.com/goki/vgpu",
        sum = "h1:5YPpI3uKZy+a7k+nsCpO4tcq/pRVKneQo+8ntsuD+Ag=",
        version = "v1.0.5",
    )
    go_repository(
        name = "com_github_goki_vulkan",
        importpath = "github.com/goki/vulkan",
        sum = "h1:FGoz5u3HY1/lMcvPSEe7PMbnJPtJIE/W2kgooTITDic=",
        version = "v0.0.0-20220928215615-c67065a9cfc2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:XPYXKIuH/n5zpUoEWk2jWV/SjEMNYmqDYmTgbjmhtaI=",
        version = "v0.0.0-20220128195007-1f435e4c2b44",
    )
    go_repository(
        name = "com_github_srwiley_rasterx",
        importpath = "github.com/srwiley/rasterx",
        sum = "h1:YR16ysw3I1bqwtEcYV9dpvhHEe7j55hIClkLoAqY31I=",
        version = "v0.0.0-20220128185129-2efea2b9ea41",
    )
    go_repository(
        name = "com_github_srwiley_scanft",
        importpath = "github.com/srwiley/scanFT",
        sum = "h1:uLR2GaV0kWYZ3Ns3l3sjtiN+mOWAQadvrL8HXcyKjl0=",
        version = "v0.0.0-20220128184157-0d1ee492111f",
    )
    go_repository(
        name = "com_github_srwiley_scanx",
        importpath = "github.com/srwiley/scanx",
        sum = "h1:ZdkidVdpLW13BQ9a+/3uerT2ezy9J7KQWH18JCfhDmI=",
        version = "v0.0.0-20190309010443-e94503791388",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:LRtI4W37N+KFebI/qV0OFiLUv4GLOWeEW5hn/KEJvxE=",
        version = "v0.0.0-20220413100746-70e8d0d3baa9",
    )
    go_repository(
