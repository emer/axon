...
func init() {
	Symbols["github.com/emer/axon/v2/axon/axon"] = map[string]reflect.Value{
		...
		"CerebOutLayer":                reflect.ValueOf(axon.CerebOutLayer),
		"CerebPredLayer":               reflect.ValueOf(axon.CerebPredLayer),
		...
		"CerebPredParams":    reflect.ValueOf((*axon.CerebPredParams)(nil)),
