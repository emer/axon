...
func init() {
	Symbols["github.com/emer/axon/v2/axon/axon"] = map[string]reflect.Value{
		...
		"GABAB":                        reflect.ValueOf(axon.GABAB),
		...
		"MatrixLayer":                  reflect.ValueOf(axon.MatrixLayer),
		...
		"PoolInhibGiFromFSSS":          reflect.ValueOf(axon.PoolInhibGiFromFSSS),
		...
		"PoolInhibSaveOrig":            reflect.ValueOf(axon.PoolInhibSaveOrig),
		...
		"PulvParams":        reflect.ValueOf((*axon.PulvParams)(nil)),
