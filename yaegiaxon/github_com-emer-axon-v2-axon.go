...
func init() {
	Symbols["github.com/emer/axon/v2/axon/axon"] = map[string]reflect.Value{
		...
		"MinusPeakCyc":                 reflect.ValueOf(axon.MinusPeakCyc),
		...
		"PlusPeak":                     reflect.ValueOf(axon.PlusPeak),
		"PlusPeakCyc":                  reflect.ValueOf(axon.PlusPeakCyc),
		...
		"TimeDiffPeak":                 reflect.ValueOf(axon.TimeDiffPeak),
		"TimeDiffPeakCyc":              reflect.ValueOf(axon.TimeDiffPeakCyc),
